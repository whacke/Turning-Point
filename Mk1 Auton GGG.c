...
//void JerkyDrive(int left, int right, int revs)
//{
...
//	}
//	}
//	else if(abs(SensorValue[leftEncoder]) > revs)
//		{
//			motor(rightBack) = motor(rightFront) = -5;
//			motor(leftBack) = motor(leftFront) = -5;
//		}
//	motor(rightBack) = motor(rightFront) = 0;
//	motor(leftBack) = motor(leftFront) = 0;
//}
...
task autonomous()
{
	...
	//forward and shoot
	SensorValue(gyro)=0;
	BasicDrive(40,40,400);
			motor(rightBack) = motor(rightFront) = -10;
			motor(leftBack) = motor(leftFront) = -10;
			wait1Msec(100);
			motor(rightBack) = motor(rightFront) = 0;
			motor(leftBack) = motor(leftFront) = 0;
	wait1Msec(1000); //little wait for ball to cycle
	motor(puncher1) = 127;
	motor(puncher2) = 127;
	wait1Msec(900);
	motor(puncher1) = 0;
	...
	motor(intake) = 127;
	//forward and shoot
	BasicDrive(40,40,335);
			motor(rightBack) = motor(rightFront) = -10;
			motor(leftBack) = motor(leftFront) = -10;
			wait1Msec(100);
			motor(rightBack) = motor(rightFront) = 0;
			motor(leftBack) = motor(leftFront) = 0;
	wait1Msec(1400); //little wait for ball to cycle
	motor(puncher1) = 127;
	motor(puncher2) = 127;
	wait1Msec(1200);
	motor(puncher1) = 0;
