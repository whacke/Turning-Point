...
task autonomous()
{
	...
	motor(leftBack) = motor(leftFront) = motor(rightBack) = motor(rightFront) = 0;
	wait1Msec(400);
	//motor(leftBack) = motor(leftFront) = 63;
	//motor(rightBack) = motor(rightFront) = -63;
	//wait1Msec(150);
	//motor(leftBack) = motor(leftFront) = motor(rightBack) = motor(rightFront) = 0;
	...
	//forward and shoot
	BasicDrive(40,40,245);
	wait1Msec(2000); //little wait for ball to cycle
	motor(puncher1) = 127;
	motor(puncher2) = 127;
	wait1Msec(900);
	motor(puncher1) = 0;
